    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey : Any]? = nil) -> Bool {
        ...
        let hasLaunched = isAppAlreadyLaunchedOnce()
            ...
            if !hasLaunched {
                ...
                addPlace(Place(name: "Beach", items: "Towel,Sunscreen,Flip Flops,Volleyball,Umbrella,Snacks,Swimwear,Cooler", key:"MKPOICategoryBeach"))
                ...
                addPlace(Place(name: "Fitness Center", items: "Water Bottle,Gym Shoes,Athletic Wear,Foam Roller,Resistance Bands,Protein Shake", key:"MKPOICategoryFitnessCenter"))
                ...
                addPlace(Place(name: "National Park", items: "Bug Spray,Sunscreen,Water Bottle,Hiking Shoes,Snacks", key:"MKPOICategoryNationalPark"))
                ...
                addPlace(Place(name: "University", items: "Textbooks,Student I.D,Laptop,Pencil Case,Bus Pass,Wallet,Notebooks", key:"MKPOICategoryUniversity"))
